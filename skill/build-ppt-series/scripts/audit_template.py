...
- source_policy: retain original template assets; add only relevant, attributable images
...
- base_style: [derive from visual inspection]
- scene_profiles: conceptual, technical, narrative, business, teaching
- palette_binding: use the audited template color roles
- generated_image_role: comprehension aid only; never factual evidence
- editable_overlay_rule: keep labels, arrows, citations, and explanatory text editable
- disclosure_rule: visibly disclose synthetic schematic visuals when they may be mistaken for evidence
...
- Recompute page count, sequence, rhythm, examples, visuals, and layout mapping.
- Use deck-only overrides for deck-specific needs.

## Prohibited

- Do not copy a previous deck page-for-page.
- Do not store deck-specific page rhythm or content here.
